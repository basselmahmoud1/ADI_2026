...
proc create_root_design { parentCell } {
  ...
  set out_c_proccesor [ create_bd_port -dir O -from 0 -to 0 out_c_proccesor ]
  ...
  connect_bd_net -net a_0_1 [get_bd_ports in_a] [get_bd_pins and_gate_0/a]
  connect_bd_net -net and_gate_0_c [get_bd_pins and_gate_0/c] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports out_c_proccesor] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net b_0_1 [get_bd_ports in_b] [get_bd_pins and_gate_0/b]
